...
import io.fabric8.forge.generator.pipeline.*;
...
public class ChooseBoosterTemp extends AbstractProjectOverviewCommand implements UIWizardStep {
    public static final String JENKINSFILE = "Jenkinsfile";

    private static final transient Logger LOG = LoggerFactory.getLogger(ChooseBoosterTemp.class);
    ...
    public UICommandMetadata getMetadata(UIContext context) {
        return Metadata.forCommand(getClass())
                ...
                .name(AbstractDevToolsCommand.CATEGORY + ": Configure Pipeline temp")
